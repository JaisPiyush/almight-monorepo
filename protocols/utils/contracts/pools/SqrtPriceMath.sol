...
library SqrtPriceMath {
    ...
    function getNextSqrtPriceFromAmount0RoundingUp(
        ...
        if (add) {
            ...
            //TODO: Add error code "Underflow"
            require((product = amount * sqrtPX96) / amount == sqrtPX96 && numerator1 > product, "UF");
            uint256 denominator = numerator1 - product;
            return uint160(FullMath.mulDivRoundingUp(numerator1, sqrtPX96, denominator));
        }
    }
    ...
    function getNextSqrtPriceFromAmount1RoundingDown(
        ...
        if (add) {
            ...
            require(sqrtPX96 > quotient, "INVALID_PRICE");
    ...
    function getNextSqrtPriceFromInput(
        ...
        require(sqrtPX96 > 0, "INVALID_PRICE");
        require(liquidity > 0, "INVALID_LIDUIDITY");
    ...
    function getAmount0Delta(
        ...
        require(sqrtRatioAX96 > 0, "INVALID_RATIO");
