...
library FullMath {
    ...
    function mulDiv(
        ...
        if (prod1 == 0) {
            /// TODO: Add error code for "InvalidDenominator"
            require(denominator > 0, "INVDEN");
            assembly {
        ...
        require(denominator > prod1, "INVDEN");
    ...
    function mulDivRoundingUp(
        ...
        if (mulmod(a, b, denominator) > 0) {
            //TODO: Add error code "OverFlow"
            require(result < type(uint256).max, "OV");
            result++;
        }
    }
}