...
library Position {
    ...
    /// @param feeGrowthInside0X128 The all-time fee growth in token0, per unit of liquidity, 
    /// inside the position's tick boundaries
    /// @param feeGrowthInside1X128 The all-time fee growth in token1, per unit of liquidity, 
    /// inside the position's tick boundaries
    function update(
        Info storage self,
